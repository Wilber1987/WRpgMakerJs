...
//             option.render == true ||  option.render == undefined || this.evaluateCondition(option.render)
//         );
...
//      * @param {boolean | Condition | Function} condition - La condición a evaluar. Puede ser un booleano directo o un objeto Condition.
